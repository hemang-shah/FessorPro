...
output = hedge_fund_portfolio.get('investments')[1].get('holdings')[0].get('yield')
#print(output)

hedge_fund_portfolio.get('investments')[2].get('holdings')[0].get('details').update({'strike_price':2000})
p=hedge_fund_portfolio.get('investments')[2].get('holdings')[0].get('details').get('strike_price')
#print(p)
...
o=foreign_exchange.get('exchange_rates').get('JPY').get('historical_rates')[1].get('rate')
#print(o)
...
o=credit_risk_profiles.get('individuals')[1].get('outstanding_loans').get('credit_card').get('interest_rate')
#print(o)
...
pp = investment_portfolio.get('assets').get('stocks')[1].get('purchase_price')
print(pp)